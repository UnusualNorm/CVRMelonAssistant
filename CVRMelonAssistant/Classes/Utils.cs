...
namespace CVRMelonAssistant
{
    public class Utils
    {
        ...
        public class Constants
        {
            ...
            public const string CVRMGModsJson = "https://covr-mods.herokuapp.com/v1/mods";
        ...
        public static string GetInstallDir()
        {
            ...
            try
            {
                // ChilloutVR is currently not available on Oculus platforms...
        ...
        {
            App.ChilloutVRInstallDirectory = directory;
            App.ChilloutVRInstallType = store;
        ...
        {
            string filename = Path.Combine(App.ChilloutVRInstallDirectory, "ChilloutVR_Data", "globalgamemanagers");
        ...
        public static string GetManualDir()
        {
            ...
            if (dialog.ShowDialog() == true)
            {
                ...
                {
                    string store;
                    if (File.Exists(Path.Combine(path, "ChilloutVR_Data", "Plugins", "x86_64", "steam_api64.dll")))
                    {
                        store = "Steam";
                    }
                    else
