...
namespace CoVRMelonAssistant
{
    public class Themes
    {
        ...
        /// <summary>
        /// Applies a loaded theme to CoVRMelonAssistant.
        /// </summary>
        ...
        public static void WriteThemeToDisk(string themeName)
        {
            ...
            if (File.Exists($@"{ThemeDirectory}\\{themeName}.xaml") == false)
            {
                 ...
                 */
                using (Stream s = Assembly.GetExecutingAssembly().GetManifestResourceStream($"CoVRMelonAssistant.Themes.{themeName}.xaml"))
                ...
                foreach (ZipArchiveEntry file in archive.Entries)
                {
                    ...
                    if (supportedVideoExtensions.Contains(videoExtension))
                    {
                        ...
                        else
                        {
                             ...
                             * already being used by CoVRMelonAssistant and causing a System.IO.IOException.
                             */
        ...
        private static BitmapImage GetImageFromEmbeddedResources(string themeName, string imageName)
        {
            ...
            var desiredResourceName = $"CoVRMelonAssistant.Themes.{themeName}.{imageName}.png";
